...
namespace jsoncpp
{    
    ParserStatesManager::NextTransition ParserStatesManager::GetNextTransition(ParserStateType current_state_type, std::istringstream& input, ParserStackSymbol stack_top)
    {
